...
import { Address, HashType, Hexadecimal, DepType } from '@ckb-lumos/lumos'
...
export function generateDepositLock(ethAddress: string, isTestNet: boolean) {
  ...
  const depositLock = new Lay2Script(
    ...
    config.layer2Config.ROLLUP_CONFIG.rollup_type_hash +
      depositLockArgsHexString.slice(2),
    Lay2HashType.type,
  )
  return depositLock
}
  ...
  SCRIPTS: {
    deposit_lock: {
      ...
      cell_dep: {
        out_point: {
          tx_hash:
            '0x61e576a7e5d2398ecc5b1a969d1af0142c87db0996c2f6fce41bf28f68d805b2',
          index: '0x0',
        },
        dep_type: 'code',
      },
    ...
    withdrawal_lock: {
      ...
      cell_dep: {
        out_point: {
          tx_hash:
            '0xe6389b5cf63eec1e2592e930414bc43f92508e529bdd5f5a07fa1dd140f4f20a',
          index: '0x0',
        },
        dep_type: 'code',
      },
